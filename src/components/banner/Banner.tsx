		...
		<section className="duration-200 grid-container bg-light-gray dark:bg-dark-banner dark:text-white transtision">
			...
			<article className="article">
				<p className="article__p2">
					Esta pagina te ayudara a conocer tus personajes favoritos de Black Clover , ademas te
					entaras de las Curiosidades que no sabias de este maravilloso Anime
				</p>
			</article>
			...
			<figure className=" article">
				<img src="/assets/liebe.jpg" className=" article__img" alt="Liebe" />
			</figure>
		</section>
	)
}
